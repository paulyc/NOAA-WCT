...
public class NexradViewerBatchExample {
   ...
   */
   ...
   public void loadNexrad(URL nexradURL) throws Exception {
...
System.out.println("FONT XY: "+x+" , "+y);        
   ...
   private Style getNexradPolygonStyle(NexradHeader header, StreamingRadialDecoder decoder) throws Exception {
