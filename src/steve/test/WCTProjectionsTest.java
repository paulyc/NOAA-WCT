...
//			
	        ...
	        LatLonPoint llPointFlatEarth = trans.projToLatLon(xInKM, yInKM);
//	        
...
//	        
	        ...
	        LatLonPoint llPointEAP = eaproj.projToLatLon(xInKM, yInKM);
//	        
...
//            	
            	...
            	System.out.println("distance between azimuthal sphere and flat earth: "+geocalc.getOrthodromicDistance());

            	geocalc.setDestinationPoint(llPointEAP_NAD83.getLongitude(), llPointEAP_NAD83.getLatitude());
            	System.out.println("distance between azimuthal sphere nad83 and flat earth: "+geocalc.getOrthodromicDistance());

            	geocalc.setAnchorPoint(llPointEAP.getLongitude(), llPointEAP.getLatitude());
            	geocalc.setDestinationPoint(ptDst.getOrdinate(0), ptDst.getOrdinate(1));
            	System.out.println("distance between azimuthal sphere and albers: "+geocalc.getOrthodromicDistance());
