 ...
 * @throws Exception 
    */
   public NexradVADPanel(DecodeL3Header header) throws Exception {
 ...
 * @throws Exception 
    */
   public void setNexradHeader(DecodeL3Header header) throws Exception {
      this.header = header;
...
//         System.out.println("PAINTING BARB "+n+" of "+vWindBarbs.size()+" rms: "+windPacket.rms);        
         
         // wind packet rms starts with 1, color array starts with 0         
         g.setColor(c[windPacket.rms-1]);
         // Start barb drawing
