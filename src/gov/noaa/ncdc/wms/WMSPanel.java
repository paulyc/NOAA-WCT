...
import gov.noaa.ncdc.wct.ui.LayerSelector;
...
//		jcomboBackground[wmsIndex].setSelectedItem(wmsName);
	...
	public void setIsBlackAndWhite(int wmsIndex, boolean isBW) {
		layerList.get(wmsIndex).getJcbBWBackground().setSelected(isBW);
	}
