...
//        }
        ...
        if (scannedFile.getLastScanResult().getDataType() == SupportedDataType.GOES_SATELLITE_AREA_FORMAT ||
        		...
        		scannedFile.getLastScanResult().getDataType() == SupportedDataType.TEXTFILE ||
        		scannedFile.getLastScanResult().getDataType() == SupportedDataType.SHAPEFILE ||
        		scannedFile.getLastScanResult().getDataType() == SupportedDataType.IMAGEFILE) {
        	
                throw new WCTExportException("Metadata output is not supported for this datatype");
