        ...
        try {
            ...
            for (int n=0; n<att.length; n++) {
                if (! featureType.getAttributeType(n).getName().equals(defaultGeometryName)) {
                	...
                	System.out.println("Att class: "+featureType.getAttributeType(n).getType().getName());
                	System.out.println("String class: "+ String.class.getName());
                	
                	if (featureType.getAttributeType(n).getType().getName().equals(String.class.getName())) {
