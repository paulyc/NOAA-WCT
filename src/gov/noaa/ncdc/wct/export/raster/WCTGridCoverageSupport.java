...
public class WCTGridCoverageSupport {
    ...
    private SampleDimension[] lastSampleDimensionsLoaded = null;
     ...
     * @throws Exception 
     */
    public GridCoverage getGridCoverage(WCTRaster wctRaster, NexradHeader header, int alpha) throws Exception {
    	
		SampleDimensionAndLabels sd = 
			NexradSampleDimensionFactory.getSampleDimensionAndLabels(header.getProductCode(), false, header.getVersion());
        ...
        lastSampleDimensionsLoaded = sdArray;
     ...
     * @throws Exception 
     */
    public GridCoverage getGridCoverage(WCTRaster wctRaster, NexradHeader header) throws Exception {
     ...
     * @throws Exception 
     */
    public GridCoverage getGridCoverage(WCTRaster wctRaster, NexradHeader header, boolean classify) throws Exception {
...
//            maxValues[0] = (double) (header.getNumberOfLevels(classify) - 1);
            minValues[0] = 1;
            maxValues[0] = (double) (header.getNumberOfLevels(classify));
        }
        else {
...
//                System.out.println("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
        ...
        lastSampleDimensionsLoaded = gc.getSampleDimensions();
...
//        System.out.println("min value = "+minValue+"  max value = "+maxValue);
    ...
    /**
     * Returns last sample dimensions created in a 'getGridCoverage' method
     * @return
     */
    public SampleDimension[] getCachedSampleDimensions() {
    	return lastSampleDimensionsLoaded;
    }
...
//        sdArray = setSampleDimensionAlpha(sdArrayOverride, alpha);
    ...
    public static SampleDimension[] setSampleDimensionAlpha(SampleDimension[] sdArray, int alpha) {
        ...
        //  Need to clone it so we don't mess up the alpha in the original sample dimensions 
    	SampleDimension[] returnSD = new SampleDimension[sdArray.length];
    	returnSD = sdArray.clone();
    	
        
        for (int n=0; n<returnSD.length; n++) {
//            System.out.println( sdArray[n].getMinimumValue() + " - " + sdArray[n].getMaximumValue() );
        	
        	
            
            List<Category> catList = returnSD[n].getCategories();
            ArrayList<Category> newCatList = new ArrayList<Category>();
...
//                		double currentAlphaPercent = 1;
                	...
                	System.out.println(alpha+" ::: "+currentAlphaPercent+" %");
            ...
            returnSD[n] = new SampleDimension((Category[])(newCatList.toArray(new Category[newCatList.size()])), null);
        }    
