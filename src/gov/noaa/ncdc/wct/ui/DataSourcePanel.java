...
public class DataSourcePanel extends JPanel {
    ...
    private BDPAccessPanel bdpPanel = null;
...
//        localPanel.add("right", localFilterPanel);
        ...
        jcbListAllFilesLocal.addActionListener(e -> viewer.getDataSelector().submitListFiles());
        jcbListAllFilesCustom.addActionListener(e -> viewer.getDataSelector().submitListFiles());
...
//        favoritesPanel.add("left", removeAllButton);
        ...
        try {
			bdpPanel = new BDPAccessPanel(viewer, submitListener);
...
//        }
    ...
    public BDPAccessPanel getBDPAccessPanel() {
    	return bdpPanel;
    }
...
//    	tabPane.setEnabled(! isLoading);
//    	bdpPanel.setEnabled(! isLoading);
//    	jbSubmitCLASS.setEnabled(! isLoading);
//    	jbSubmitCustom.setEnabled(! isLoading);
//    	jbSubmitHAS.setEnabled(! isLoading);
//    	jbSubmitLocal.setEnabled(! isLoading);
//    	jbSubmitThredds.setEnabled(! isLoading);
//    	jcomboCLASS.setEnabled(! isLoading);
//    	jcomboCustom.setEnabled(! isLoading);
//    	jcomboHAS.setEnabled(! isLoading);
//    	jcomboLocal.setEnabled(! isLoading);
//    	jcomboThredds.setEnabled(! isLoading);
//    	jtfCLASSListFilter.setEnabled(! isLoading);
//    	jtfCustomListFilter.setEnabled(! isLoading);
//    	jtfFavoriteListFilter.setEnabled(! isLoading);
//    	jtfHASListFilter.setEnabled(! isLoading);
//    	jtfLocalListFilter.setEnabled(! isLoading);
//    	jtfTHREDDSListFilter.setEnabled(! isLoading);
//    	jcomSortByFavorites.setEnabled(! isLoading);
//    	jcomSortByCLASS.setEnabled(! isLoading);
//    	jcomSortByCustom.setEnabled(! isLoading);
//    	jcomSortByHAS.setEnabled(! isLoading);
//    	jcomSortByLocal.setEnabled(! isLoading);
//    	jcomSortByThredds.setEnabled(! isLoading);
//    	jcbListAllFilesCustom.setEnabled(! isLoading);
//    	jcbListAllFilesLocal.setEnabled(! isLoading);

    	
//    	WCTUiUtils.setPanelEnabled(this, ! isLoading);
...
//        }
    ...
    public void setDataLocation(String dataType, String location) throws Exception {
        ...
        else if (dataType.equals(WCTDataSourceDB.NOAA_BDP_AWS)) {
            jcomboSingleFileSource.setSelectedItem(location);
        }
        else {
            throw new Exception("dataType: '"+dataType+"' is not supported.");
