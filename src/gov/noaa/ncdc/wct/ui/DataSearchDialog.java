...
//			dialog.setVisible(true);
	...
	private void createUI() {
		...
		jbAddMarker.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				try {
					GeocodeResult ggr = googleGeocoder.locationSearch(jtfLocation.getText(), viewer.getCurrentExtent()).get(0);
...
//	}
	...
	private void locationSearch(String location) {
		try {
			...
			GeocodeResult ggr = googleGeocoder.locationSearch(location, viewer.getCurrentExtent()).get(0);
