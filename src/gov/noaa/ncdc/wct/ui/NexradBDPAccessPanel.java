...
public class NexradBDPAccessPanel extends JPanel implements BDPAccessSubPanel {

	public final static String AWS_BUCKET_ROOT = "https://s3.amazonaws.com/noaa-nexrad-level2";
...
//	private JList<String> fileList;
	private JComboBox<String> siteList, providerList;
	...
	private void createGUI() {
		...
		picker.getMonthView().addActionListener(new ActionListener() {			
			@Override
			public void actionPerformed(ActionEvent evt) {
				System.out.println("picker.getMonthView().addActionListener(new ActionListener()");
				// refresh upper bound, in case the next GMT day becomes available after picker has been created
				picker.getMonthView().setUpperBound(new Date());
				selectDate(picker.getDate());
			}
...
//					System.out.println("adding " + s);
	...
	@Override
	/**
	 * Currently datasetID is not used and can be anything
	 */
