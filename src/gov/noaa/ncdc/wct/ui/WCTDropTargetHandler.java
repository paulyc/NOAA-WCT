    ...
    public void drop(DropTargetDropEvent event) {
        ...
        if (transferable.isDataFlavorSupported(DataFlavor.stringFlavor)) {
            ...
            try {
                ...
                // first switch old http www1 links to new https
                s = s.replace("http://www1.ncdc.noaa.gov", "https://www1.ncdc.noaa.gov");
                ...
                if (s.startsWith("HAS") && s.length() == 12) {
                    ...
                    bdpAccessPanel.getNexradBDPAccessPanel().setDate(yyyymmdd);
                    bdpAccessPanel.getNexradBDPAccessPanel().setSite(siteid);
