...
//			url = ResourceUtils.getInstance().getJarResource(mapDataURL, ResourceUtils.RESOURCE_CACHE_DIR, "/shapefiles/states-natearth-360.shp", viewer);
			url = ResourceUtils.getInstance().getJarResource(mapDataURL, ResourceUtils.RESOURCE_CACHE_DIR, "/shapefiles/states-from-census-county_500k-360.shp", viewer);
			ShapefileDataStore ds = new ShapefileDataStore(url);
			FeatureSource fs = ds.getFeatureSource("states-from-census-county_500k-360");
			...
			TextSymbolizer ts = sb.createTextSymbolizer(new Color(235, 167, 0), font, "STATE_NAME");
...
//			
		...
		try {
			...
			url = ResourceUtils.getInstance().getJarResource(mapDataURL, ResourceUtils.RESOURCE_CACHE_DIR, "/shapefiles/cb_2017_us_county_500k.shp", viewer);
//			url = ResourceUtils.getInstance().getJarResource(mapDataURL, ResourceUtils.RESOURCE_CACHE_DIR, "/shapefiles/counties.shp", viewer);
			...
			FeatureSource fsCounties = dsCounties.getFeatureSource("cb_2017_us_county_500k");
			...
			TextSymbolizer tsCounties = sb.createTextSymbolizer(new Color(169, 99, 49), font, "NAME");
