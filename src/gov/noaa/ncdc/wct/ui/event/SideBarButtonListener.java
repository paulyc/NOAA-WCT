...
//            	viewer.getGridProps().setVisible(true);
        ...
        else if (e.getActionCommand().equalsIgnoreCase("Location/Station Properties")) {
            if (viewer.getStationPointProperties() != null) {
            	
        		// true toggle visibility if unmoved
        		if (viewer.getStationPointProperties().getLocation().x == viewer.getX()+39 && 
        				viewer.getStationPointProperties().getLocation().y == viewer.getY()+35) {
        			viewer.getStationPointProperties().setVisible(! viewer.getStationPointProperties().isVisible());
        		}
        		else {
        			viewer.getStationPointProperties().setVisible(true);
        			viewer.getStationPointProperties().setLocation(viewer.getX()+39, viewer.getY()+35);
        		}
            }
        }
