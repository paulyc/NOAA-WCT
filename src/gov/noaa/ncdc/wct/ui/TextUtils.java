...
//    }
    ...
    public void save(Component parent, String text, String extension, String formatDescription) throws IOException {
    	save(parent, text, extension, formatDescription, "text_export_dir");
    }

    public void save(Component parent, String text, String extension, String formatDescription, String wctPropKey) throws IOException {

        // Set up File Chooser
        String saveDirectory = WCTProperties.getWCTProperty(wctPropKey);
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            if (choice == JOptionPane.YES_OPTION) {
                ...
                WCTProperties.setWCTProperty(wctPropKey, saveDirectory);
