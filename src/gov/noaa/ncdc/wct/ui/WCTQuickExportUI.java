...
public class WCTQuickExportUI {
	...
	public void showExportRasterDialog(final Dialog parentDialog, final WCTRaster raster) {
		...
		final JDialog exportDialog = new JDialog(parentDialog, "Data Export", ModalityType.DOCUMENT_MODAL);
...
//		mainPanel.add(jbBrowse, "right");
		...
		jbExport.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				...
				try {
					doExportInBackground(raster, jtfOutDir.getText(), jtfOutFile.getText(), (ExportFormat)jcomboFormat.getSelectedItem());
				} catch (Exception e) {
					reportException(e);
				}
			}			
...
//		System.out.println(jcomboFormat.getSelectedItem());
	...
	private void doExportInBackground(final WCTRaster bimage, final String outDir, final String outFile, final ExportFormat format) throws Exception {
		
            foxtrot.Worker.post(new foxtrot.Task() {
                public Object run() {

                    try {
                    	doExport(bimage, outDir, outFile, format);
                    } catch (Exception ex) {
                        ex.printStackTrace();
                        reportException(ex);
                    }
	...
	private void doExport(final WCTRaster raster, final String outDir, String outFile, final ExportFormat format) {
