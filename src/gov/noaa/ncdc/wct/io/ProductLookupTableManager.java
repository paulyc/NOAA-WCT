...
public class ProductLookupTableManager {
    ...
    private static HashMap<String, String> lutColorTableMap = new HashMap<String, String>();
     ...
     * First column is prod code, second is description, third is default color table
     * @param path
     * @throws IOException
     */
...
//            System.out.println("ProductLookupTableManager: LOADING: '"+path+"'");
            ...
            while ( (str = br.readLine()) != null) {
                ...
                if (cols.length == 2) {
                	...
                	lutMap.put(cols[0], cols[1]);
                	lutColorTableMap.put(cols[0], cols[2]);
                }
            }
            br.close();
...
//            System.out.println("ProductLookupTableManager: " + path + " IS ALREADY LOADED");
    ...
    public String getProductDefaultColorMap(String prodKey) {
        return lutColorTableMap.get(prodKey);
    }
