...
public class ScanResults {
    ...
    private String referenceURLorDOI;
    private String defaultColorTable;
    private URL url;
	...
	public String getCollectionReference() {
		return referenceURLorDOI;
	}
    
	public void setCollectionReference(String referenceURLorDOI) {
		this.referenceURLorDOI = referenceURLorDOI;
	}
	
	public String getDefaultColorTable() {
		return defaultColorTable;
	}
	
	public void setDefaultColorTable(String defaultColorTable) {
    ...
    public String toString() {
        return dataType+": "+getFileName()+" - '"+ getDisplayName() + "' || ext=" + getExtension() + " || productID=" + getProductID()
                + " || timestamp=" + getTimestamp() +" || longname='"+getLongName()+"' || defaultColorTable="+defaultColorTable;
    }
