...
//        return saveName;
    ...
    public void scanURL(URL url) throws DecodeException, MalformedURLException, UnsupportedEncodingException, SQLException, ParseException {
        ...
        if (WCTUtils.getSharedCancelTask().isCancel()) {
        	System.err.println("scanURL - returning because download was canceled");
        	return;
        }
...
//            String elevAngle = fmt2.format((double) ((DecodeL3Header)nwsheader).getProductSpecificValue(2) / 10.0) + "° ";
            ...
            scanResults.setDisplayName(nwsheader.getICAO() + " " + "p"+nwsheader.getProductCode() + " " +
                  elevAngle + 
                  nwsheader.getDate() + " " + nwsheader.getHourString() + ":" + nwsheader.getMinuteString() + " Z");
    ...
    public ScanResults quickScan(String filename) throws ParseException {
        ...
        try {
        	...
        	//  	System.out.println("FilenamePatternParser.getDataType(p) found nothing");
        ...
        try {
            ...
            defaultColorTable = FilenamePatternParser.getDefaultColorTable(p, filename);
        } catch (Exception e) {
//            System.out.println("PRODUCT LUT ERROR: "+e);
        ...
        try {
            collectionReference = FilenamePatternParser.getCollectionReference(p, filename);
        } catch (Exception e) {
//            System.out.println("PRODUCT LUT ERROR: "+e);
            e.printStackTrace();
        }
        ...
        results.setCollectionReference(collectionReference);
        results.setDefaultColorTable(defaultColorTable);
