...
//        NOT NEEDED BECAUSE NWS SWITCHED TO ONLY HTTPS
...
//      NOT NEEDED BECAUSE NWS SWITCHED TO ONLY HTTPS
        if (directoryURL.getProtocol().equals("ftp") && directoryURL.getHost().equals("tgftp.nws.noaa.gov")) {
    ...
    public ScanResults[] scanListResults(ListResults listResults, boolean includeUnknownTypes) 
        ...
        for (int n=0; n<urlList.length; n++) {
            try {
                ...
                //	System.out.println(includeUnknownTypes+" "+urlList[n]+" "+scanResults);                
