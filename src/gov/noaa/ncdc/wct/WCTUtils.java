...
public class WCTUtils {
	...
	public final static DecimalFormat DECFMT_0D00000 = new DecimalFormat("0.00000");
    ...
    public final static SimpleDateFormat YYYYMMDD_LOCALTZ_FORMATTER = new SimpleDateFormat("yyyyMMdd");
    public final static SimpleDateFormat SCAN_RESULTS_FORMATTER = new SimpleDateFormat("yyyyMMdd HH:mm:ss");
    public final static SimpleDateFormat LEGEND_FORMATTER = new SimpleDateFormat("MM/dd/yyyy HH:mm:ss");
    ...
    static {
    	...
    	LEGEND_FORMATTER.setTimeZone(TimeZone.getTimeZone("GMT"));
    }
	...
	/**
	 * if resolutionX > 10000 || resolutionX < 0.001 then use DECFMT_SCI
	 * else use DECFMT_0D0000 
	 * @param val
	 * @return
	 */
	public static String smartFormat(double val) {
        if (val > 100000 || val < 0.0001) {
            return WCTUtils.DECFMT_SCI.format(val);
        }
        else {
            return WCTUtils.DECFMT_0D00000.format(val);
        }
	}
...
//    	System.out.println("arrays: "+Arrays.toString(str.split(" +")));
	...
	/**
	 * Supposedly fancier than a fancy regex.  Doesn't split strings with commas that
	 * are inside quotes.
	 * @param s
	 * @return
	 */
	public static ArrayList<String> customSplitCSV(String s) {
	...
	public static String getPad(String col, String data) {
		if (col.length() < 10) {
			StringBuilder sb = new StringBuilder();
			sb.append(col);
	...
	public static String getPad(String str, int padToLength) {
		StringBuilder sb = new StringBuilder();
		sb.append(str);
