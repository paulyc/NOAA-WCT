...
//        }
        ...
        try {
//        	System.out.println("registering climdiv.");
            CoordSysBuilder.registerConvention("ClimDiv-1.0", gov.noaa.ncdc.wct.decoders.cdm.conv.ClimDivConvention.class);
            WCTIospManager.getInstance().registerIosp(gov.noaa.ncdc.iosp.station.ClimDivIOServiceProvider.class);
        } catch (Exception e) {
            e.printStackTrace();
            errors += "Error registering convention gov.noaa.ncdc.iosp.station.ClimDivIOServiceProvider.class\n";
        }
...
//        try {
//        	System.out.println("registering climdiv conv.");
//            CoordSysBuilder.registerConvention("ClimDiv", gov.noaa.ncdc.wct.decoders.cdm.conv.ClimDivConvention.class);
//        } catch (Exception e) {
//            e.printStackTrace();
//            errors += "Error registering convention gov.noaa.ncdc.wct.decoders.cdm.conv.ClimDivConvention.class\n";
//        }
