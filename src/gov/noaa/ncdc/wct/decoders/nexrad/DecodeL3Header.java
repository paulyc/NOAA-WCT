...
public class DecodeL3Header implements NexradHeader {
    ...
    /**
     * Returns Date of volume scan creation in milliseconds from 1970-1-1 GMT
     *
     * @return    The date value
     */
    public long getScanMilliseconds() {
        return scanCalendar.getTimeInMillis();
    }
...
//            System.out.println("NEXRAD IDs::::::::::::::: "+icao+", "+approxICAO);
            ...
            if (verbose) {
                ...
                if (pcode==173) System.out.println("end time: "+(int)(productSpecific[0]/60)+":"+(productSpecific[0]%60));
                if (pcode==173) System.out.println("time span: "+(int)(productSpecific[1]/60)+":"+(productSpecific[1]%60));
                for (int i=0; i<10; i++)
            ...
            scanCalendar.setTimeZone(TimeZone.getTimeZone("GMT"));
            
            
            yyyymmdd = NexradEquations.convertJulianDate(gendate);
            str = new Integer(yyyymmdd).toString();            
            year = Integer.parseInt(str.substring(0, 4));
            month = Integer.parseInt(str.substring(4, 6));
            day = Integer.parseInt(str.substring(6, 8));
            hour = gentime/3600;
            minute = (gentime/60)%60;
            seconds = gentime - getHour()*3600 - getMinute()*60;
...
//                pcode == 165      // DHC
                ...
                pcode == 166) 
        {
            ...
            return L3RSL;
                ...
                pcode == NexradHeader.L3PC_MET_SIGNAL
