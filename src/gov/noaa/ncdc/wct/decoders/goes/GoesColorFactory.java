...
//            System.out.println(Arrays.deepToString(vals));
            ...
            return ColorsAndValues.calculateEqualColorsAndValues(new ColorsAndValues(c, vals, raster.getUnits()));
        }
...
//        }
        ...
        return new ColorsAndValues(colors, values, null);
    }
...
//          System.out.println("start cmap read");
            ...
            if (raster.getLastBandDecoded() == Band.BAND1) {
                ...
                return new ColorsAndValues(c, vals, raster.getUnits());
