...
//    private static final long NATIVE_GRID_CACHE_SIZE_LIMIT = 8000*4000;
    private static final long DEFAULT_NATIVE_GRID_CACHE_SIZE_LIMIT = 2000*2000;
    private long nativeGridSizeCacheLimit = DEFAULT_NATIVE_GRID_CACHE_SIZE_LIMIT;
...
//        this.bounds = bounds;  --- DON'T DO THIS, because bounds will come from native bounds if not resmapling
        ...
        try {
            ...
            this.imgWidth = grid.getXDimension().getLength();
            this.imgHeight = grid.getYDimension().getLength();
            this.envelope = new Envelope(this.bounds);
            ...
            if (! checkGridCacheSizeLimit()) {
                throw new WCTExportException("This lat/lon grid is too large for 'native' read. \n" +
                		...
                		"Max number of pixels allowed: "+ nativeGridSizeCacheLimit);
            }
...
//            System.out.println("y cell size: "+this.bounds.getHeight() / this.raster.getHeight());
    ...
    private boolean checkGridCacheSizeLimit() {        
        return ! (this.coordSys.getXHorizAxis().getSize() * this.coordSys.getYHorizAxis().getSize() > nativeGridSizeCacheLimit);        
    }
...
//            }
	...
	public long getNativeGridSizeCacheLimit() {
		return nativeGridSizeCacheLimit;
	}


	public void setNativeGridSizeCacheLimit(long nativeGridSizeCacheLimit) {
		this.nativeGridSizeCacheLimit = nativeGridSizeCacheLimit;
	}
