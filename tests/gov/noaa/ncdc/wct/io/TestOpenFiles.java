...
//	@Test
	public void testWctExportNative() throws WCTExportNoDataException, WCTExportException, DecodeException, 
		...
		URL dataURL = new URL("https://www1.ncdc.noaa.gov/pub/data/nexradviewer/testdata/goes/goes12.2004.247.212513.BAND_01");
...
//	@Test
	public void testFileWriter2() throws Exception {
		...
		URL remoteURL = new URL("https://www1.ncdc.noaa.gov/pub/data/nexradviewer/testdata/goes/goes12.2004.247.212513.BAND_01");
...
//        NetcdfFile ncOut = ucar.nc2.FileWriter2.writeToFile(ncIn, outFile.toString(), listeners);
        FileWriter2 writer2 = new FileWriter2(ncIn, outFile.toString(), Version.netcdf3, null); 
