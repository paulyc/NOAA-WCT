...
public class WCTDirectoryScannerTest {
    ...
    public void testCustomHTTP() {
        ...
        try {
//            System.out.println("dirScanner.scanURL(new URL(\"https://www1.ncdc.noaa.gov/pub/data/nexradviewer/katrina/data/klix-level2\"));");
//            scanResults = dirScanner.scanUrlDirectory(new URL("https://www1.ncdc.noaa.gov/pub/data/nexradviewer/katrina/data/klix-level2"), false);
